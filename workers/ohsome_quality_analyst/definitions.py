...
INDICATOR_LAYER = (
    ...
    ("MappingSaturation", "arable_land_area"),
    ("MappingSaturation", "permanent_crops_area"),
    ("MappingSaturation", "pastures_area"),
    ("MappingSaturation", "forest_area"),
    ("MappingSaturation", "leaf_type"),
    ("MappingSaturation", "shrub_area"),
    ("MappingSaturation", "open_spaces_area"),
    ("MappingSaturation", "wetland_area"),
    ("MappingSaturation", "water_area"),
    ("MappingSaturation", "waterway_len"),
    ...
    ("Currentness", "arable_land_area"),
    ("Currentness", "permanent_crops_area"),
    ("Currentness", "pastures_area"),
    ("Currentness", "forest_area"),
    ("Currentness", "leaf_type"),
    ("Currentness", "shrub_area"),
    ("Currentness", "open_spaces_area"),
    ("Currentness", "wetland_area"),
    ("Currentness", "water_area"),
    ("Currentness", "waterway_len"),
    ("PoiDensity", "poi"),
