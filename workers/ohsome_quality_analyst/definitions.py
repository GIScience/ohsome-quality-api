...
INDICATOR_LAYER = (
    ...
    ("MappingSaturation", "school_count"),
    ("MappingSaturation", "kindergarten_count"),
    ("MappingSaturation", "clinic_count"),
    ("MappingSaturation", "doctors_count"),
    ("MappingSaturation", "bus_stop_count"),
    ("MappingSaturation", "tram_stop_count"),
    ("MappingSaturation", "subway_station_count"),
    ...
    ("Currentness", "poi"),
    ("Currentness", "lulc"),
    ("Currentness", "school_count"),
    ("Currentness", "kindergarten_count"),
    ("Currentness", "clinic_count"),
    ("Currentness", "doctors_count"),
    ("Currentness", "bus_stop_count"),
    ("Currentness", "tram_stop_count"),
    ("Currentness", "subway_station_count"),
    ("PoiDensity", "poi"),
