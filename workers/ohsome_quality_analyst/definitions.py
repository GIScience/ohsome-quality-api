...
INDICATOR_LAYER = (
    ...
    ("MappingSaturation", "fire_stations"),
    ("MappingSaturation", "hospitals"),
    ...
    ("MappingSaturation", "railway_length"),
    ("MappingSaturation", "clc_arable_land_area"),
    ("MappingSaturation", "clc_permanent_crops_area"),
    ("MappingSaturation", "clc_pastures_area"),
    ("MappingSaturation", "clc_forest_area"),
    ("MappingSaturation", "clc_leaf_type"),
    ("MappingSaturation", "clc_shrub_area"),
    ("MappingSaturation", "clc_open_spaces_area"),
    ("MappingSaturation", "clc_wetland_area"),
    ("MappingSaturation", "clc_water_area"),
    ("MappingSaturation", "clc_waterway_len"),
    ...
    ("PoiDensity", "poi"),
    ("AttributeCompleteness", "building_count"),
    ("AttributeCompleteness", "major_roads_length"),
    ("AttributeCompleteness", "jrc_health_count"),
    ("AttributeCompleteness", "jrc_education_count"),
    ("AttributeCompleteness", "jrc_road_length"),
    ("AttributeCompleteness", "jrc_airport_count"),
    ("AttributeCompleteness", "jrc_power_generation_plant_count"),
    ("AttributeCompleteness", "jrc_cultural_heritage_site_count"),
    ("AttributeCompleteness", "jrc_bridge_count"),
    ("AttributeCompleteness", "jrc_mass_gathering_sites_count"),
    ("AttributeCompleteness", "clc_leaf_type"),
    ("Minimal", "minimal"),
)
