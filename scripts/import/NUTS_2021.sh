...
ogr2ogr -f PostgreSQL PG:"host=localhost port=5432 dbname=hexadmin user=hexadmin" NUTS_RG_01M_2021_4326.geojson
ogr2ogr -f PostgreSQL PG:"host=localhost port=5432 dbname=hexadmin user=hexadmin" NUTS_RG_60M_2021_4326.geojson
