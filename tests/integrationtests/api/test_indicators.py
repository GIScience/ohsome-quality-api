...
@oqapi_vcr.use_cassette
def test_mapping_saturation_fc(
    client,
...
def test_mapping_saturation_additional_parameter_attribute(
...
def test_mapping_saturation_custom_topic_missing_filter(
    client, bpolys, headers, schema
):
    endpoint = ENDPOINT + "mapping-saturation"
...
def test_mapping_saturation_custom_topic_key_with_filter(
    client, bpolys, headers, schema
):
    endpoint = ENDPOINT + "mapping-saturation"
    parameters = {
