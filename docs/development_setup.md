...
dependencies management. Please make sure it is installed on your system using `pip` or
`pipx`.
...
curl \
    -X GET "http://127.0.0.1:8080/indicator/mapping-saturation?topic=building_count&dataset=regions&featureId=1" \
