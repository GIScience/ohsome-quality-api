...
if "FASTAPI_I18N__LOCALE_DIR" not in os.environ:
    os.environ["FASTAPI_I18N__LOCALE_DIR"] = os.path.join(
...
app = FastAPI(
    ...
    docs_url=get_config_value("docs_url"),
    redoc_url=None,
    title=__title__,
...
async def metadata_topic() -> Any:
    """Get topics."""
    return {"result": get_topic_presets()}
...
async def metadata_indicators() -> Any:
    """Get metadata of all indicators."""
    return {"result": get_indicator_metadata()}
