...
ogr2ogr -f PostgreSQL PG:"dbname=hexadmin user=$POSTGRES_USER" -nln "nuts_rg_60M_2021" NUTS_RG_01M_2021_4326.geojson
ogr2ogr -f PostgreSQL PG:"dbname=hexadmin user=$POSTGRES_USER" -nln "nuts_rg_60M_2021" NUTS_RG_60M_2021_4326.geojson
