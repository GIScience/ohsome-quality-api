...
ogr2ogr -f PostgreSQL "PG:dbname=$POSTGRES_DB user=$POSTGRES_USER" gadm36.gpkg
ogr2ogr -f PostgreSQL "PG:dbname=$POSTGRES_DB user=$POSTGRES_USER" gadm36_levels.gpkg
