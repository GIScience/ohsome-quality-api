...
class sigmoidCurve:
    ...
    def initparamsFor2JumpsCurve(self, xdata, ydata):
        ...
        # hstack is because boundaries needs to be the same length as flatter
        ...
        try:
            ...
            # Here is the index from which (inclusive) we should start masking away:
            # ie  ind the latest boundary before our jump, and the first following it:
            startMask, endMask = (
            ...
            # This zeros out the slope on a contiguous region around our first jump.
