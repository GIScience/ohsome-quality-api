...
- add new layers `schools`, `kindergarten`, `clinics`, `doctors`, `bus_stops`, `tram_stops`, `subway_stations`, `marketplaces`. `parks`, `forests`, `fitness_centres` and `supermarkets` ([#444])
